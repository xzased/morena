$(document).ready(function() {
    $('a#agregar-portada').on('click', function(event) {
        event.preventDefault();
        $.ajax({
            url: '/org/agregar_portada',
            type: 'GET',
    ...
    $('a#borrar-portada').on('click', function(event) {
        event.preventDefault();
        var list = [];
    ...
    $('a#modificar-portada').on('click', function(event) {
        event.preventDefault();
    ...
    $('body').on('submit', 'form#portada', function(event) {
        event.preventDefault();
